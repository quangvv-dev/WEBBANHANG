            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-2 col-sm-2">
                     <div class="logo"><a href="{{url('home')}}"><img src="images/logo.png" alt="FlatShop"></a></div>
                  </div>
         ...
         <div class="container_fullwidth">
            <div class="container">
               ...
               @foreach($category as $a)
                  ...
                  <h3 class="title"><strong>{{$a->name_category}}</strong> </h3>
                  <div class="control"><a id="prev_hot" class="prev" href="#">&lt;</a><a id="next_hot" class="next" href="#">&gt;</a></div>
                  <ul id="hot">
                     <li>
                        <div class="row">
                        @foreach($a->product->sortByDesc('id') as $p1)
                           ...
                           <div class="col-md-3 col-sm-6">
                              ...
                              <div class="products">
                                 ...
                                 <div class="thumbnail"><a href="detail_p/{{$p1->id}}"><img src="images/{{$p1->image}}" alt="Product Name" width="200px"/></a></div>
                                 <div class="productname">{{$p1->name}}</div>
                                 <h4 class="price">{{$p1->price}}</h4>
                                 <div class="button_group"><button class="button add-cart" type="button"><a href="gio-hang/{{$p1->id}}">Add To Cart</a></button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           @endif
                           @endforeach
